...
class MapService {
  ...
  // 마커 사이즈 --------------------------------------
  let imageSize = new this.kakao.maps.Size(35, 34); // 마커이미지의 크기입니다
  let imgOptions = {offset: new this.kakao.maps.Point(15, 35)}; // 마커이미지의 옵션입니다. 마커의 좌표와 일치시킬 이미지 안에서의 좌표를 설정합니다.
    // --------------------------------------------------
    ...
    if (this.keyword.match("축구")) {
      ...
      imageSrc = fitness;
       ...
       imageSize = new this.kakao.maps.Size(36, 37);
       imgOptions = {
